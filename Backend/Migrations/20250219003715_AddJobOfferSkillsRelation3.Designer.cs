...
namespace Backend.Migrations
{
    ...
    [Migration("20250219003715_AddJobOfferSkillsRelation3")]
    partial class AddJobOfferSkillsRelation3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.JobOffer.JobOfferRequiredSkills", b =>
                {
                    b.Property<int>("JobOfferId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("JobOfferRequiredSkills");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "0f84cfa9-7cf2-45d7-a6c5-4f721c61b4e9",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "9c46bb07-153c-4841-b8c6-e7e782be0a94",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Backend.Models.JobOffer.JobOfferRequiredSkills", b =>
                {
                    b.HasOne("Backend.Models.JobOffer.JobOffer", "JobOffer")
                        .WithMany("JobOfferRequiredSkills")
                        .HasForeignKey("JobOfferId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Backend.Models.JobOffer.Skill", "Skill")
                        .WithMany("JobOfferRequiredSkills")
            ...
            modelBuilder.Entity("Backend.Models.JobOffer.JobOffer", b =>
                {
                    ...
                    b.Navigation("JobOfferRequiredSkills");
