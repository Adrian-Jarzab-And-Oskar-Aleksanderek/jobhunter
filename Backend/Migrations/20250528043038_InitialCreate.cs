    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NiceToHaveSkills", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NiceToHaveSkills_JobOffers_JobOfferId",
                        column: x => x.JobOfferId,
                        principalTable: "JobOffers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequierdSkills", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RequierdSkills_JobOffers_JobOfferId",
                        column: x => x.JobOfferId,
                        principalTable: "JobOffers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NiceToHaveSkillsId = table.Column<int>(type: "integer", nullable: true),
                    RequierdSkillsId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NiceToHaveSkills_JobOfferId",
                table: "NiceToHaveSkills",
                column: "JobOfferId");

            migrationBuilder.CreateIndex(
                name: "IX_RequierdSkills_JobOfferId",
                table: "RequierdSkills",
                column: "JobOfferId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_JobOffers_Skills_SkillId",
                table: "JobOffers",
                column: "SkillId",
